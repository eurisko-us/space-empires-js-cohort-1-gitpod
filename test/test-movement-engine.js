...
if (JSON.stringify(testOne.players[0].units[0].coords) != JSON.stringify({"x": 7, "y": 6}))
  console.log(`\n\tTest 1 did not pass, the unit did not move to the right, 1 hex. The final coords was ${JSON.stringify(testOne.players[0].units[0].coords)}`);
else
  console.log(`\n\tTest 1 Passed!`)
...
if (JSON.stringify(testTwo.players[0].units[0].coords) != JSON.stringify({"x": 6, "y": 7}))
  console.log(`\n\tTest 2 did not pass, the unit did not move downwards, 1 hex. The final coords was ${JSON.stringify(testTwo.players[0].units[0].coords)}`);
else
  console.log(`\n\tTest 2 Passed!`)
...
if (JSON.stringify(testThree.players[0].units[0].coords) != JSON.stringify({"x": 5, "y": 6}))
  console.log(`\n\tTest 3 did not pass, the unit did not move to the left, 1 hex. The final coords was ${JSON.stringify(testThree.players[0].units[0].coords)}`);
else
  console.log(`\n\tTest 3 Passed!`)
...
if (JSON.stringify(testFour.players[0].units[0].coords) != JSON.stringify({"x": 6, "y": 5}))
  console.log(`\n\tTest 4 did not pass, the unit did not move upwards, 1 hex. The final coords was ${JSON.stringify(testFour.players[0].units[0].coords)}`);
else
  console.log(`\n\tTest 4 Passed!`)
...
if (JSON.stringify(testFive.players[0].units[0].coords) != JSON.stringify({"x": 9, "y": 6}))
  console.log(`\n\tTest 5 did not pass, the unit did not move to the right, 3 hexes. The final coords was ${JSON.stringify(testFive.players[0].units[0].coords)}`);
else
  console.log(`\n\tTest 5 Passed!`)
...
if (JSON.stringify(testSix.players[0].units[0].coords) != JSON.stringify({"x": 6, "y": 9}))
  console.log(`\n\tTest 6 did not pass, the unit did not move downwards, 3 hexes. The final coords was ${JSON.stringify(testSix.players[0].units[0].coords)}`);
else
  console.log(`\n\tTest 6 Passed!`)
...
if (JSON.stringify(testSeven.players[0].units[0].coords) != JSON.stringify({"x": 3, "y": 6}))
  console.log(`\n\tTest 7 did not pass, the unit did not move to the left, 3 hexes. The final coords was ${JSON.stringify(testSeven.players[0].units[0].coords)}`);
else
  console.log(`\n\tTest 7 Passed!`)
...
if (JSON.stringify(testEight.players[0].units[0].coords) != JSON.stringify({"x": 6, "y": 3}))
  console.log(`\n\tTest 8 did not pass, the unit did not move upwards, 3 hexes. The final coords was ${JSON.stringify(testEight.players[0].units[0].coords)}`);
else
  console.log(`\n\tTest 8 Passed!`)

console.log(`\nTesting Upgraded Movement with 3 Movement Rounds`);

upgradedTech = { "attack": 0, "defense": 0, "movement": 5, "unitsize": 1, "unityard": 1, "terraform": 0, "tactics": 0, "exploration": 0 };
...
if (JSON.stringify(testNine.players[0].units[0].coords) != JSON.stringify({"x": 12, "y": 6}))
  console.log(`\n\tTest 9 did not pass, the unit did not move to the right, 6 hexes. The final coords was ${JSON.stringify(testNine.players[0].units[0].coords)}`);
else
  console.log(`\n\tTest 9 Passed!`)
...
if (JSON.stringify(testTen.players[0].units[0].coords) != JSON.stringify({"x": 6, "y": 12}))
  console.log(`\n\tTest 10 did not pass, the unit did not move downwards, 6 hexes. The final coords was ${JSON.stringify(testTen.players[0].units[0].coords)}`);
else
  console.log(`\n\tTest 10 Passed!`)
...
if (JSON.stringify(testEleven.players[0].units[0].coords) != JSON.stringify({"x": 0, "y": 6}))
  console.log(`\n\tTest 11 did not pass, the unit did not move to the left, 6 hexes. The final coords was ${JSON.stringify(testEleven.players[0].units[0].coords)}`);
else
  console.log(`\n\tTest 11 Passed!`)
...
if (JSON.stringify(testTwelve.players[0].units[0].coords) != JSON.stringify({"x": 6, "y": 0}))
  console.log(`\n\tTest 12 did not pass, the unit did not move upwards, 6 hexes. The final coords was ${JSON.stringify(testTwelve.players[0].units[0].coords)}`);
else
  console.log(`\n\tTest 12 Passed!`)
...
if (JSON.stringify(testThirteen.players[0].units[0].coords) != JSON.stringify({"x": 6, "y": 5}) && JSON.stringify(testThirteen.players[1].units[0].coords) != JSON.stringify({"x": 6, "y": 5}))
  console.log(`\n\tTest 13 did not pass, the units moved past eachother. The final coords of the first unit was ${JSON.stringify(testThirteen.players[0].units[0].coords)}. The final coords of the second unit was ${JSON.stringify(testThirteen.players[1].units[0].coords)}`);
else
  console.log(`\n\tTest 13 Passed!\n`)