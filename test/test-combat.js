...
p1Units = [new Scout(0, [0,0], 0, p0.technology, 0), new Scout(0, [2,1], 1, p0.technology, 0), new Scout(0, [2,1], 2, p0.technology, 0), new Scout(0, [2,1], 3, p0.technology, 0), new Destroyer(0, [0,0], 4, p0.technology, 0), new ColonyUnit(0, [0,0], 5, p0.technology, 0)]
p2Units = [new Scout(1, [0,0], 0, p1.technology, 0), new Scout(1, [2,1], 1, p1.technology, 0), new ColonyUnit(1, [0,0], 2, p1.technology, 0), new Scout(1, [2,1], 3, p1.technology, 0), new ColonyUnit(1, [2,1], 4, p1.technology, 0)]
